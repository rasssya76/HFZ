...
semoga Betah yak `;
const outro = `1 MEMBER TELAH GUGUR \n MARILAH KITA BERSAMA-SAMA MEMBACA SURAT ALFATIHAH UNTUK MENGHORMATI KEPERGIAN MEMBER`
...
//client.sendButDoc(id, text1,desc1,fs.readFileSync('./stik/thumbnaildokumen.jpg'), but, options1)
